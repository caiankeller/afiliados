...
function FileUpload({
  ...
  const fileChecker = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    <>
      <div className="flex items-stretch gap-2">
        ...
        <button
          ...
          text-neutral-900 hover:invert hover:bg-neutral-200 hover:outline outline-1 outline-black disabled:cursor-not-allowed [&_svg]:hover:duration-300 [&_svg]:disabled:translate-x-0 [&_svg]:disabled:rotate-0 [&_svg]:disabled:translate-y-0 [&_svg]:translate-y-1 [&_svg]:hover:ease-out [&_svg]:hover:translate-x-1 [&_svg]:hover:-translate-y-1 [&_svg]:hover:-rotate-45 hover:animate-pulse"
          onClick={sendFile}
        >
          {isLoading ? (
            <>
